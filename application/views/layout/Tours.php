    ...
    <div class="filter-grid">
      <div class="filter-group">
        ...
        <select name="destination" id="destination">
          ...
          <?php foreach ($destinations as $destination): ?>
            <option value="<?php echo html_escape($destination); ?>" <?php echo ($filters['destination'] == $destination) ? 'selected' : ''; ?>>
      ...
      <div class="filter-group">
        ...
        <select name="duration" id="duration">
          ...
          <?php foreach ($durations as $duration): ?>
            <option value="<?php echo html_escape($duration); ?>" <?php echo ($filters['duration'] == $duration) ? 'selected' : ''; ?>>
      ...
      <div class="filter-group">
        ...
        <select name="month" id="month">
          ...
          <?php foreach ($months as $month): ?>
            <option value="<?php echo $month; ?>" <?php echo ($filters['month'] == $month) ? 'selected' : ''; ?>>
              <?php echo $month; ?>
            </option>
          <?php endforeach; ?>
        </select>
      ...
      <div class="filter-group">
        ...
        <div class="price-range">
          <input type="number" name="min_price" placeholder="Min" value="<?php echo html_escape($filters['min_price']); ?>">
          <input type="number" name="max_price" placeholder="Max" value="<?php echo html_escape($filters['max_price']); ?>">
        </div>
      </div>
    </div>
  ...
  <div class="tours-grid" id="Daftar_Paket">
    <?php if (!empty($tours)): ?>
      <?php foreach ($tours as $tour): ?>
        <div class="tour-card">
          <img src="<?php echo base_url('assets/images/' . html_escape($tour['image'])); ?>" alt="<?php echo html_escape($tour['title']); ?>" class="tour-image">
